...
function rotate {
	...
	normal)
		...
		gnome-randr.py --output $DNAME --rotate normal
		;;
	bottom-up)
		NEW_ROT="inverted"
		CTM="-1 0 1 0 -1 1 0 0 1"
		#gsettings set com.canonical.Unity.Launcher launcher-position Top
		gnome-randr.py --output $DNAME --rotate inverted
		;;
	right-up)
		NEW_ROT="left"
		CTM="0 -1 1 1 0 0 0 0 1"
		#gsettings set com.canonical.Unity.Launcher launcher-position Left
		gnome-randr.py --output $DNAME --rotate right
		;;
	left-up)
		NEW_ROT="right"
		CTM="0 1 0 -1 0 1 0 0 1"
		#gsettings set com.canonical.Unity.Launcher launcher-position Left
		gnome-randr.py --output $DNAME --rotate left
		;;
	esac
